...
public class OutfitLenderNPC implements ZoneConfigurator {
	...
	private void initOutfits() {
		...
		final Pair<Outfit, Boolean> JUMPSUIT = new Pair<Outfit, Boolean>(new Outfit(null, null, null, null, Integer.valueOf(83), null), true);
		final Pair<Outfit, Boolean> DUNGAREES = new Pair<Outfit, Boolean>(new Outfit(null, null, null, null, Integer.valueOf(84), null), true);
		final Pair<Outfit, Boolean> GREEN_DRESS = new Pair<Outfit, Boolean>(new Outfit(null, null, null, null,	Integer.valueOf(78), null), true);

		final Pair<Outfit, Boolean> GOWN = new Pair<Outfit, Boolean>(new Outfit(null, null, null, null, Integer.valueOf(82), null), true);
		final Pair<Outfit, Boolean> NOOB = new Pair<Outfit, Boolean>(new Outfit(null, null, null, null, Integer.valueOf(80), null), true);
		// FIXME: eyes may be visible over new outfits
		final Pair<Outfit, Boolean> GLASSES = new Pair<Outfit, Boolean>(new Outfit(null, null, null, Integer.valueOf(99), null, null), true);
		final Pair<Outfit, Boolean> GLASSES_2 = new Pair<Outfit, Boolean>(new Outfit(null, null, null, Integer.valueOf(79), null, null), true);
		final Pair<Outfit, Boolean> HAT = new Pair<Outfit, Boolean>(new Outfit(null, Integer.valueOf(99), null, null, null, null), true);

		// these outfits must replace the current outfit (what's null simply isn't there)
		// FIXME: eyes may be visible over new outfits
		final Pair<Outfit, Boolean> BUNNY = new Pair<Outfit, Boolean>(new Outfit(null, Integer.valueOf(00), null, Integer.valueOf(98), Integer.valueOf(81), Integer.valueOf(98)), false);
		final Pair<Outfit, Boolean> HORSE = new Pair<Outfit, Boolean>(new Outfit(0, Integer.valueOf(00), null, Integer.valueOf(98), Integer.valueOf(00), Integer.valueOf(97)), false);
		final Pair<Outfit, Boolean> GIRL_HORSE = new Pair<Outfit, Boolean>(new Outfit(0, Integer.valueOf(00), null, Integer.valueOf(98), Integer.valueOf(00), Integer.valueOf(96)), false);
		final Pair<Outfit, Boolean> ALIEN = new Pair<Outfit, Boolean>(new Outfit(null, Integer.valueOf(00), null, Integer.valueOf(98), Integer.valueOf(00), Integer.valueOf(95)), false);
